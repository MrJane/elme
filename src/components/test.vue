        ...
        <el-tabs type="border-card" class="main_table">
          <el-tab-pane class="clearfix">
            ...
            <div class="totalBtn fl">
              ...
              <template v-for="item in tabChoice" :key="$index">
                <p><span @click="showTab($index)">所有</span></p>
                <div class="triangle-right"></div>
                <div class="triangle-right floatCover" :class="{actives:activesIndex===$index}"></div>
              </template>
  ...
  export default {
    ...
    data () {
      return {
        ...
        //tabChoice
        tabChoice: ['所有', '加入职位', '人才推荐', '客户面试', 'offer', '到岗', '可结案', '放弃']
      };
    },
    computed: {},
    mounted () {
